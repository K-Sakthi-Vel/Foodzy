...
const OurPromises = () => {
    return (
        <section className='w-full container mx-auto mt-10 mb-10 px-4'>
            <div className='flex flex-wrap items-center md:justify-between justify-center gap-2 text-center'>
                <div className="flex flex-col items-center">
                    <img src={Promise1} alt="Promise 1" className="h-22 w-auto" />
                    <p className="mt-2 font-semibold">Best prices & offers</p>
                </div>
                <div className="flex flex-col items-center">
                    <img src={Promise2} alt="Promise 2" className="h-22 w-auto" />
                    <p className="mt-2 font-semibold">Free delivery</p>
                </div>
                <div className="flex flex-col items-center">
                    <img src={Promise3} alt="Promise 3" className="h-22 w-auto" />
                    <p className="mt-2 font-semibold">Great daily deal</p>
                </div>
                <div className="flex flex-col items-center">
                    <img src={Promise4} alt="Promise 4" className="h-22 w-auto" />
                    <p className="mt-2 font-semibold">Wide assortment</p>
                </div>
                <div className="flex flex-col items-center">
                    <img src={Promise5} alt="Promise 5" className="h-22 w-auto" />
