        ...
        <div className="grid grid-cols-12 md:grid-cols-12 gap-y-8 md:gap-y-0 gap-x-4 lg:gap-x-10">
          ...
          <div className="col-span-12 md:col-span-12 lg:col-span-4">
            ...
            <div className="flex space-x-2 mb-6 mt-4"> {/* Added mt-4 for spacing */}
                <a href="https://www.facebook.com/KLSakthi.333/" target='_blank' className="w-9 h-9 flex items-center justify-center border border-gray-300 rounded-md text-gray-600 hover:bg-red-500 hover:text-white"><Facebook size={16} /></a>
                <a href="https://x.com/klsakthi333" target='_blank'className="w-9 h-9 flex items-center justify-center border border-gray-300 rounded-md text-gray-600 hover:bg-red-500 hover:text-white"><Twitter size={16} /></a>
                <a href="https://dribbble.com/SAKTHI333" target='_blank'className="w-9 h-9 flex items-center justify-center border border-gray-300 rounded-md text-gray-600 hover:bg-red-500 hover:text-white"><Dribbble size={16} /></a>
                <a href="https://www.instagram.com/haha___sakthi/" target='_blank'className="w-9 h-9 flex items-center justify-center border border-gray-300 rounded-md text-gray-600 hover:bg-red-500 hover:text-white"><Instagram size={16} /></a>
            </div>
